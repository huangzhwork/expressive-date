...
class ExpressiveDate extends \DateTime
{
    ...
    /**
     * Use the start of the time
     * 
     * @return ExpressiveDate
     */
    public function startOfTime()
    {
        $this->setMinute(0)
            ->setSecond(0);
        return $this;
    ...
    {
        $this->minusDays($this->getDayOfWeekAsNumeric())
            ->startOfDay();
    ...
    {
        $this->addDays(6 - $this->getDayOfWeekAsNumeric())
            ->endOfDay();
    ...
    public function setWeekStartDay($weekStartDay)
    {
        if (is_numeric($weekStartDay)) {
            ...
            $this->weekStartDay = array_search(strtolower($weekStartDay), array(
                'sunday',
                'monday'
            ));
        }
